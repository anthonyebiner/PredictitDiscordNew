...
async def on_message(message):
    if message.author == client.user:
        ...
        await message.channel.send(msg)
    elif message.content.startswith(",Risk all") or message.content.startswith(",risk all") or message.content.startswith(
            ",r all"):
        ...
        print("Risk")
        title, info = api.optimize_all(max_shares=850)
